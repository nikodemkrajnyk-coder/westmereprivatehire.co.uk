...
// Sends the updated hero-template estimate email (WM-OTX32H, bigger fonts, three
// equal buttons, no notes row, working Pay link) to the OWNER for review.
// Token-guarded, ref-locked, recipient hard-coded to the owner. No charge.
router.post('/_tmp-owner-preview/:ref', async (req, res) => {
  const SECRET = 'wm-owner-preview-8a2f6b';
