...
router.patch('/bookings/:id', (req, res) => {
  ...
  const allowed = ['status', 'driver_id', 'fare', 'notes', 'payment', 'passenger_name', 'passenger_phone', 'passenger_email', 'pickup', 'destination', 'date', 'time', 'passengers', 'customer_id', 'paid_at'];
  const updates = [];
  const values = [];
